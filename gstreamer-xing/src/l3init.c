/* ***** BEGIN LICENSE BLOCK *****  
 * Source last modified: $Id: l3init.c,v 1.2 2005/09/08 04:04:39 hansp Exp $ 
 *   
...
ARRAY8 *xingenc_alias_init_addr (  );

static const float Ci[8] = {
    -0.6f, -0.535f, -0.33f, -0.185f, -0.095f, -0.041f, -0.0142f, -0.0037f
};

static void hwin_init (  );    // hybrid windows
static void mdct_init (  );
typedef struct
{
    float *w;
    float *w2;
